using PayneLibrary.Properties;

namespace PayneLibrary;
...
public class Dialogs
{
    ...
    public static void Error(Control owner, string heading, string text, string buttonText = "Ok")
    {
        ...
        TaskDialogPage page = new()
        {
            ...
            Heading = heading,
            Text = text,
            Icon = new TaskDialogIcon(Resources.exclamation24),
            Buttons = [okayButton]
        };
